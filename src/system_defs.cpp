                        ...
                        unsigned bufpoolsize, const char* replacement_policy )
{
    ...
    real_logname = (char *)malloc(strlen(logname) + 20);
    real_dbname = (char *)malloc(strlen(dbname) + 20);
...
{   
    ...
    logname = (char *)malloc(strlen(dbname) + 20);
    real_dbname = (char *)malloc(strlen(dbname) + 20);
...
#define GlobalShMemMgr this
    ...
    minibase_globals = this;
        ...
        GlobalBufMgr = new(BufMgrAddress) BufMgr(bufpoolsize, replacement_policy);
